...
Page headings are calculated locally from the active journal's saved records. They report patterns and missing information, not predictions or proof of an edge. Delete actions require an explicit red confirmation.
