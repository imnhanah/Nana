...
export default function ChallengeModeSettings({challenge, enabled}) {
  ...
  return <div className="tj-challenge-mode-settings">
    ...
    <small>Click Save to apply mode and level changes and reset progress and streaks. Trades logged afterward count, with or without close timing. Gross P&amp;L excludes commission and swap. Excess is not carried forward.</small>
