...
:root {
  ...
  --tj-text: #F4F5F7; --tj-muted: #A0A7B2; --tj-green: #228B22; --tj-red: #F87171;
  --tj-purple: #8B7CF6; --tj-blue: #60A5FA; --tj-amber: #FBBF24;
  --tj-input-bg: #1B1E24; --tj-chart-bg: #131519; --tj-chart-grid: #303640; --tj-chart-text: #CDD3DC;
  --tj-tooltip-bg: #1B1E24; --tj-primary-hover: #1B6F1B; --tj-primary-muted: rgba(34,139,34,0.15);
...
.tj-logo img { display: block; width: 64px; height: 64px; object-fit: contain; border-radius: 50%; mix-blend-mode: multiply; filter: drop-shadow(0 2px 5px rgba(0,0,0,.18)); }
.tj-theme-light .tj-logo img { mix-blend-mode: multiply; } .tj-theme-dark .tj-logo img { mix-blend-mode: normal; }
