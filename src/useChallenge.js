...
export default function useChallenge(account, userId) {
  ...
  useEffect(()=>{setRecord(null);latest.current=null;flight.current=null;setSaving(false);if(isChallengeEnabled(account))void reload();},[key,!!account?.challengeEnabled,reload]);
